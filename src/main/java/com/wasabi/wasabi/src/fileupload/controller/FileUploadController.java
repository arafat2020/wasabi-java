...
public class FileUploadController {
    ...
    public ResponseEntity<FileUploadResponse> uploadFile(
            ...
            @Parameter(description = "File description", required = false)
            @RequestParam(value = "description", required = false) String description,
            
            @Parameter(description = "Whether the file is public", required = false)
            @RequestParam(value = "isPublic", required = false, defaultValue = "true") Boolean isPublic,
            
            @Parameter(description = "Username of the uploader", required = true)
    ...
    @Operation(
        ...
        description = "Upload multiple files with optional metadata"
    )
    ...
    public ResponseEntity<List<FileUploadResponse>> uploadMultipleFiles(
            ...
            @Parameter(description = "Files description", required = false)
            @RequestParam(value = "description", required = false) String description,
            
            @Parameter(description = "Whether the files are public", required = false)
            @RequestParam(value = "isPublic", required = false, defaultValue = "true") Boolean isPublic,
    ...
    @GetMapping("/type")
    public ResponseEntity<List<FileUploadResponse>> getFilesByType(@RequestParam("contentType") String contentTypePrefix) {
